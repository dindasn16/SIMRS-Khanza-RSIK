    ...
    private void tampil(String user) {        
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.tagihan_masuk,user.tambahan_biaya,user.potongan_biaya,user.resep_obat,user.resume_pasien,user.penyakit_igd,user.penyakit_ralan,user.penyakit_ranap,user.kamar,"+
                ...
                "user.surat_pulang_atas_permintaan_sendiri,user.template_hasil_radiologi,user.hitung_toi,user.hitung_bto,user.hitung_gdr,user.hitung_ndr,user.hapus_data_salah from user where user.id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1,user);
                rs=ps.executeQuery();
                while(rs.next()){
                    ...
                    if("[I]Frekuensi Penyakit IGD".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[I]Frekuensi Penyakit IGD",rs.getBoolean("penyakit_igd")});
                    }
                    ...
                    if("[I]Hitung TOI".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[I]Hitung TOI",rs.getBoolean("hitung_toi")});
                    }
                                        
                    if("[I]Hitung BTO".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[I]Hitung BTO",rs.getBoolean("hitung_bto")});
                    }
                                        
                    if("[I]Hitung GDR".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[I]Hitung GDR",rs.getBoolean("hitung_gdr")});
                    }
                                        
                    if("[I]Hitung NDR".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[I]Hitung NDR",rs.getBoolean("hitung_ndr")});
                    }
                    ...
                    if("[S]Hapus Data Salah".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[S]Hapus Data Salah",rs.getBoolean("hapus_data_salah")});
                    }                         
                }       
...
//                System.out.println(e);
    ...
    private void Simpan() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[I]Frekuensi Penyakit IGD".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penyakit_igd='"+tbUser.getValueAt(i,2).toString()+"'");
            }            
            ...
            if("[I]Hitung TOI".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","hitung_toi='"+tbUser.getValueAt(i,2).toString()+"'");
            }            

            if("[I]Hitung BTO".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","hitung_bto='"+tbUser.getValueAt(i,2).toString()+"'");
            }            

            if("[I]Hitung GDR".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","hitung_gdr='"+tbUser.getValueAt(i,2).toString()+"'");
            }            

            if("[I]Hitung NDR".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","hitung_ndr='"+tbUser.getValueAt(i,2).toString()+"'");
            }            
    ...
    private void Simpan2() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[S]Hapus Data Salah".equals(tbUser.getValueAt(i,1).toString())){

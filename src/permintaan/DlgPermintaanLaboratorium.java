...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(560, 150));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-10-2022" }));
        ...
        TanggalPA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-10-2022" }));
        ...
        TanggalBahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-10-2022" }));
    ...
    private void isPsien(){
        try {
            pstindakan=koneksi.prepareStatement(
                "select reg_periksa.no_rkm_medis,reg_periksa.kd_pj,reg_periksa.kd_dokter,dokter.nm_dokter,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.umur,"+

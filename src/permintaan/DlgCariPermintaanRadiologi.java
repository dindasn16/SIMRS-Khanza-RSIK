...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","No.Rawat","Pasien","Alamat","Tanggal Lahir","Umur","Cara Bayar","Permintaan","Jam","Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Poli Registrasi","Informasi Tambahan","Diagnosis Klinis"
            }){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{
                "No.Permintaan","No.Rawat","Pasien","Alamat","Tanggal Lahir","Umur","Cara Bayar","Pemeriksaan","Permintaan","Jam","Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Poli Registrasi","Informasi Tambahan","Diagnosis Klinis"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tabMode3=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","No.Rawat","Pasien","Alamat","Tanggal Lahir","Umur","Cara Bayar","Permintaan","Jam","Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Kamar Terakhir","Informasi Tambahan","Diagnosis Klinis"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tabMode4=new DefaultTableModel(null,new Object[]{
                "No.Permintaan","No.Rawat","Pasien","Alamat","Tanggal Lahir","Umur","Cara Bayar","Pemeriksaan","Permintaan","Jam","Sampel","Jam","Hasil","Jam","Kode Dokter","Dokter Perujuk","Kamar Terakhir","Informasi Tambahan","Diagnosis Klinis"
            }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
                ...
                if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                    ...
                    if(akses.getkode().equals("Admin Utama") || akses.getperiksa_radiologi()){                    
                        if(Sequel.cariInteger("select count(noorder) from permintaan_pemeriksaan_radiologi where stts_bayar='Sudah' and noorder=?",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString())>0){
                            ...
                            int reply = JOptionPane.showConfirmDialog(rootPane,"Apakah yakin menghapus data ???","Konfirmasi",JOptionPane.YES_NO_OPTION);
                            if (reply == JOptionPane.YES_OPTION) { 
                                Sequel.meghapus("hasil_radiologi","no_rawat",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),1).toString());                                                                
                                Sequel.meghapus("periksa_radiologi","no_rawat",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),1).toString());
                                Sequel.meghapus("permintaan_pemeriksaan_radiologi","noorder",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString());
                        ...
                        JOptionPane.showMessageDialog(null,"Maaf anda tidak memiliki hak akses untuk menghapus data !!!");                    
                    }                     
                }
            }else{            
                ...
                if(tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString().trim().equals("")){
                    ...
                    if(akses.getkode().equals("Admin Utama") || akses.getperiksa_radiologi()){                    
                        if(Sequel.cariInteger("select count(noorder) from permintaan_pemeriksaan_radiologi where stts_bayar='Sudah' and noorder=?",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString())>0){
                            ...
                            int reply = JOptionPane.showConfirmDialog(rootPane,"Apakah yakin menghapus data ???","Konfirmasi",JOptionPane.YES_NO_OPTION);
                            if (reply == JOptionPane.YES_OPTION) { 
                                Sequel.meghapus("hasil_radiologi","no_rawat",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),1).toString());                                                                
                                Sequel.meghapus("periksa_radiologi","no_rawat",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),1).toString());
                                Sequel.meghapus("permintaan_pemeriksaan_radiologi","noorder",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString());                                
    ...
    */
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    "select permintaan_radiologi.noorder,permintaan_radiologi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.tgl_lahir,pasien.umur,penjab.png_jawab,permintaan_radiologi.tgl_permintaan,"+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nm_pasien"),rs.getString("alamat"),rs.getString("tgl_lahir"),
                        rs.getString("umur"),rs.getString("png_jawab"),                      
    ...
    private void tampil2() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "jns_perawatan_radiologi.nm_perawatan,permintaan_radiologi.tgl_permintaan,"+
    ...
    private void getData() {
        if(tbRadiologiRalan.getSelectedRow()!= -1){
            ...
            Permintaan=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),7).toString();
            JamPermintaan=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),8).toString();
            Sampel=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),9).toString();
            JamSampel=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),10).toString();
            Hasil=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),11).toString();
            JamHasil=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),12).toString();
            KodeDokter=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),13).toString();
            DokterPerujuk=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),14).toString();
            Ruang=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),15).toString();
            InformasiTambahan=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),16).toString();
            Klinis=tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),17).toString();
        }
    }
    ...
    private void getData2() {
        if(tbRadiologiRanap.getSelectedRow()!= -1){
            ...
            Permintaan=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),7).toString();
            JamPermintaan=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),8).toString();
            Sampel=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),9).toString();
            JamSampel=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),10).toString();
            Hasil=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),11).toString();
            JamHasil=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),12).toString();
            KodeDokter=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),13).toString();
            DokterPerujuk=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),14).toString();
            Ruang=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),15).toString();
            InformasiTambahan=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),16).toString();
            Klinis=tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),17).toString();
        }
    }

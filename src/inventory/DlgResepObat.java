...
//            tampil();
//           }
            JOptionPane.showMessageDialog(null,"Pastikan menghapus data resep obat di Data Pemberian Obat\nCara Menghapus :\nRanap/Ralan > Klik Kanan Pasien > Obat > Data Pemberian Obat!!!!");
            Sequel.meghapus("resep_obat","no_resep",NoResep.getText());
            Sequel.meghapus("resep_dokter","no_resep",NoResep.getText());
            tampil();  
            }
...
//                    "where resep_obat.no_resep='"+NoResep.getText()+"' and data_batch.kode_brng=databarang.kode_brng and aturan_pakai.aturan<>''",param);
    ...
    private void ppLembarObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObatActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(akses.getkode().equals("Admin Utama")){
                param.put("petugas","Petugas Farmasi");
            }else{

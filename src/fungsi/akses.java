...
//            penyakit_igd=false,hitung_toi=false,hitung_bto=false,hitung_gdr=false,hitung_ndr=false,kunjungan_ralan2=true,data_HAIs_ralan=true,hapus_data_salah=false,harian_HAIs_ralan=true,bulanan_HAIs_ralan=true;
            penyakit_igd=false,hitung_toi=false,hitung_bto=false,hitung_gdr=false,hitung_ndr=false,hapus_data_salah=false;
       ...
       try {                
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.penyakit_igd=true;                        
                        akses.hitung_toi=true;
                        akses.hitung_bto=true;
                        akses.hitung_gdr=true;
                        akses.hitung_ndr=true;
//                        akses.kunjungan_ralan2=true;    
//                        akses.data_HAIs_ralan=true;  
                        akses.hapus_data_salah=true;
//                        akses.harian_HAIs_ralan=true;  
//                        akses.bulanan_HAIs_ralan=true;                        
                        ...
                        akses.penyakit_igd=rs2.getBoolean("penyakit_igd");                        
                        akses.hitung_toi=rs2.getBoolean("hitung_toi");
                        akses.hitung_bto=rs2.getBoolean("hitung_bto");
                        akses.hitung_gdr=rs2.getBoolean("hitung_gdr");
                        akses.hitung_ndr=rs2.getBoolean("hitung_ndr"); 
//                        akses.kunjungan_ralan2=rs2.getBoolean("kunjungan_ralan2"); 
//                        akses.data_HAIs_ralan=rs2.getBoolean("data_HAIs_ralan");
                        akses.hapus_data_salah=rs2.getBoolean("hapus_data_salah");                        
//                        akses.harian_HAIs_ralan=rs2.getBoolean("harian_HAIs_ralan");
//                        akses.bulanan_HAIs_ralan=rs2.getBoolean("bulanan_HAIs_ralan");                        
...
;                    }else if((rs.getRow()==0)&&(rs2.getRow()==0)){
                        ...
                        akses.penyakit_igd= false;                        
                        akses.hitung_toi=false;
                        akses.hitung_bto=false;
                        akses.hitung_gdr=false;
                        akses.hitung_ndr=false;
//                        akses.kunjungan_ralan2=false;    
//                        akses.data_HAIs_ralan=false;    
                        akses.hapus_data_salah=false;
//                        akses.harian_HAIs_ralan=false;
//                        akses.bulanan_HAIs_ralan=false;                        
                    }
                } catch (Exception e) {
    ...
    public static boolean getpenyakit_igd(){return akses.penyakit_igd;}         
    public static boolean gethitung_toi(){return akses.hitung_toi;}
    public static boolean gethitung_bto(){return akses.hitung_bto;}
    public static boolean gethitung_gdr(){return akses.hitung_gdr;}
    public static boolean gethitung_ndr(){return akses.hitung_ndr;}
//    public static boolean getkunjungan_ralan2(){return akses.kunjungan_ralan2;}
//    public static boolean getdata_HAIs_ralan(){return akses.data_HAIs_ralan;}
    public static boolean gethapus_data_salah(){return akses.hapus_data_salah;}
//    public static boolean getharian_HAIs_ralan(){return akses.harian_HAIs_ralan;}
//    public static boolean getbulanan_HAIs_ralan(){return akses.bulanan_HAIs_ralan;}    
}   

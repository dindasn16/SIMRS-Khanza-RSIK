 ...
 */
public class DlgKunjunganRalan2 extends javax.swing.JDialog {
...
//    private String setbaru="",setlama="",umurlk="",umurpr="",kddiangnosa="",diagnosa="",status="",nilai="";
    private String setbaru="",setlama="",umurlk="",umurpr="",kddiangnosa="",diagnosa="",status="";
    public DlgKunjunganRalan2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8,1);
        setSize(885,674);

        tabMode=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","Cara Bayar","UMUM","PT","JKD","BPJS","Tindakan","Dokter Jaga"}){
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{"No.","Lama","Baru","Nama Pasien","Cara Bayar","UMUM","PT","JKD","BPJS","Tindakan","Dokter Jaga"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        setName("Form"); // NOI18N
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(464, 638));
        setResizable(false);
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if(TabRawat.getSelectedIndex()==0){
            ...
            if(namadokter.isEmpty()){
                JOptionPane.showMessageDialog(null,"Pilih Nama Dokter Terlebih Dahulu !!!");
            }else{
                tampil();
            }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptKunjunganRalan2.jasper","report","::[ Laporan Kunjungan Rawat Jalan 2 ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgKunjunganRalan2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgKunjunganRalan2 dialog = new DlgKunjunganRalan2(new javax.swing.JFrame(), true);
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,pasien.jk,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar " +
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    try {
                        ...
                        System.out.println("laporan.DlgKunjunganRalan2.tampil() 2 :"+e);
                    } finally{
                        if(rs2!=null){
                            rs2.close();
                        }
                    ...
                    tabMode.addRow(new Object[]{
                        i,setlama,setbaru,rs.getString("nm_pasien"),rs.getString("penjab.png_jawab"),"","","","","",rs.getString("nm_dokter"),
                    });                
                    i++;
                }
//                if(i>=2){
...
//                }
                ...
                System.out.println("laporan.DlgKunjunganRalan2.tampil() : "+e);
            } finally{
                if(rs!=null){
                    rs.close();
                }
        ...
        try{   
            ...
            if(nmpoli.getText().trim().equals("")&&nmdokter.getText().trim().equals("")&&nmpenjab.getText().trim().equals("")&&nmkabupaten.getText().trim().equals("")&&nmkecamatan.getText().trim().equals("")&&nmkelurahan.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ...
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar," +
                        "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                        "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab)as almt_pj,penjab.png_jawab,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar " +
                        "from reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab " +
                        "inner join kabupaten inner join kecamatan inner join kelurahan on reg_periksa.kd_dokter=dokter.kd_dokter " +
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj " +
                        "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel " +

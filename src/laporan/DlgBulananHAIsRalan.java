...
public class DlgBulananHAIsRalan extends javax.swing.JDialog {
    ...
    private int i=0,antibiotik=0,pasien=0,jmlpasien=0,UC=0,ISK=0,IDO=0,ANTIBIOTIK=0,
                jmlUC,jmlISK,jmlIDO,jmlANTIBIOTIK;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgBulananHAIsRalan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='22%'>Hari Pemasangan</td>"+
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='40%' colspan='2'>Infeksi</td>"+
            ...
            ps=koneksi.prepareStatement(
                    "select data_HAIs_ralan.tanggal from data_HAIs_ralan inner join reg_periksa inner join poliklinik inner join penjab on data_HAIs_ralan.kd_poli=poliklinik.nm_poli and data_HAIs_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where tanggal between ? and ? and poliklinik.nm_poli like ? and penjab.png_jawab like ? group by tanggal order by tanggal");
            try {
                i=1;
                jmlUC=0;
                jmlpasien=0;jmlISK=0;jmlIDO=0;jmlANTIBIOTIK=0;                        
                ...
                rs=ps.executeQuery();
                while(rs.next()){
                    pasien=Sequel.cariInteger("select count(data_HAIs_ralan.no_rawat) from data_HAIs_ralan inner join reg_periksa inner join poliklinik inner join penjab on data_HAIs_ralan.kd_poli=poliklinik.nm_poli and data_HAIs_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs_ralan.tanggal=? and poliklinik.nm_poli like ? and penjab.png_jawab like ?",rs.getString("tanggal"),"%"+Poli.getText().trim()+"%","%"+NmPenjab.getText().trim()+"%");
                    jmlpasien=jmlpasien+pasien;
                    UC=Sequel.cariInteger("select sum(data_HAIs_ralan.UC) from data_HAIs_ralan inner join reg_periksa inner join poliklinik inner join penjab on data_HAIs_ralan.kd_poli=poliklinik.nm_poli and data_HAIs_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs_ralan.tanggal=? and poliklinik.nm_poli like ? and penjab.png_jawab like ?",rs.getString("tanggal"),"%"+Poli.getText().trim()+"%","%"+NmPenjab.getText().trim()+"%");
                    jmlUC=jmlUC+UC;
                    ISK=Sequel.cariInteger("select sum(data_HAIs_ralan.ISK) from data_HAIs_ralan inner join reg_periksa inner join poliklinik inner join penjab on data_HAIs_ralan.kd_poli=poliklinik.nm_poli and data_HAIs_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs_ralan.tanggal=? and poliklinik.nm_poli like ? and penjab.png_jawab like ?",rs.getString("tanggal"),"%"+Poli.getText().trim()+"%","%"+NmPenjab.getText().trim()+"%");
                    jmlISK=jmlISK+ISK;
                    IDO=Sequel.cariInteger("select sum(data_HAIs_ralan.IDO) from data_HAIs_ralan inner join reg_periksa inner join poliklinik inner join penjab on data_HAIs_ralan.kd_poli=poliklinik.nm_poli and data_HAIs_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs_ralan.tanggal=? and poliklinik.nm_poli like ? and penjab.png_jawab like ?",rs.getString("tanggal"),"%"+Poli.getText().trim()+"%","%"+NmPenjab.getText().trim()+"%");
                    jmlIDO=jmlIDO+IDO;
                    ANTIBIOTIK=Sequel.cariInteger("select count(data_HAIs_ralan.no_rawat) from data_HAIs_ralan inner join reg_periksa inner join poliklinik inner join penjab on data_HAIs_ralan.kd_poli=poliklinik.nm_poli and data_HAIs_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.kd_pj=penjab.kd_pj where data_HAIs_ralan.ANTIBIOTIK<>'' and tanggal=? and poliklinik.nm_poli like ? and penjab.png_jawab like ?",rs.getString("tanggal"),"%"+Poli.getText().trim()+"%","%"+NmPenjab.getText().trim()+"%");

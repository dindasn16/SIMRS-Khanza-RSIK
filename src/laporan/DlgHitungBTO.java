 ...
 */
public class DlgHitungBTO extends javax.swing.JDialog {
    ...
    public DlgHitungBTO(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Hitung BTO ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgHitungBTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgHitungBTO dialog = new DlgHitungBTO(new javax.swing.JFrame(), true);
        ...
        try{   
            ...
            try {
                ...
                if(hari>0){
                    ...
                    tabMode.addRow(new Object[]{"","","","Perhitungan BTO ",": ("+pasien+" / "+kamar+")","","",Valid.SetAngka4(pasien/kamar)+" Kali",""});
                }                    
            } catch (Exception e) {
        ...
        try{   
            ...
            try {
                ...
                if(hari>0){
                    ...
                    tabMode2.addRow(new Object[]{"","","","Perhitungan BTO ",": ("+pasien+" / "+kamar+")","","",Valid.SetAngka4(pasien/kamar)+" Kali",""});
                }                    
            } catch (Exception e) {

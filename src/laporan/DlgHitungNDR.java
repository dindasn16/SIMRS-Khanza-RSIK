 ...
 */
public class DlgHitungNDR extends javax.swing.JDialog {
    ...
    private int i=0,kamar=0,jumlahhari=0,pasien=0;
    private double hari;
    private DlgCariBangsal ruang=new DlgCariBangsal(null,false);
    public DlgHitungNDR(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(691, 149));
        setName("Form"); // NOI18N
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(464, 512));
        setResizable(false);

        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Hitung NDR ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(TabRawat.getSelectedIndex()==0){
            if(tabMode.getRowCount()==0){
                ...
                Valid.MyReportqry("rptHitungBor.jasper","report","::[ Data Hitung NDR ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
        }else if(TabRawat.getSelectedIndex()==1){
            if(tabMode2.getRowCount()==0){
                ...
                Valid.MyReportqry("rptHitungBor.jasper","report","::[ Data Hitung TOI ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgHitungNDR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgHitungNDR dialog = new DlgHitungNDR(new javax.swing.JFrame(), true);
...
//                    jumlahhari=Sequel.cariInteger("select (to_days('"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"')-to_days('"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"'))")+1;
                    ...
                    tabMode.addRow(new Object[]{"","","","Perhitungan TOI ",": ((("+kamar+" X "+jumlahhari+") - " +hari+") / "+pasien+")" ,"","",Valid.SetAngka4(((kamar*jumlahhari)-hari)/pasien)+" hari",""});
//                    tabMode.addRow(new Object[]{"","","","Perhitungan BOR ",": ("+hari+"/("+kamar+" X "+jumlahhari+")) X 100%","","",Valid.SetAngka4((hari/(kamar*jumlahhari))*100)+" %",""});
                }                    
            } catch (Exception e) {
                System.out.println("laporan.DlgHitungTOI.tampil() : "+e);
            } finally{
                if(rs!=null){
                    rs.close();
                }

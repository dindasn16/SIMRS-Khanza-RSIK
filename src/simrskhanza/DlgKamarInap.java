...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnStatusMeninggalKurang = new javax.swing.JMenuItem();
        MnStatusMeninggalLebih = new javax.swing.JMenuItem();
        ...
        cmbStatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sehat", "Rujuk", "APS", "+", "Meninggal", "Meninggal < 48 Jam", "Meninggal > 48 Jam", "Sembuh", "Membaik", "Pulang Paksa", "-", "Pindah Kamar", "Status Belum Lengkap", "Atas Persetujuan Dokter", "Atas Permintaan Sendiri", "Isoman", "Lain-lain" }));
        cmbStatus.setSelectedIndex(13);
        ...
        MnStatusMeninggalKurang.setBackground(new java.awt.Color(255, 255, 254));
        MnStatusMeninggalKurang.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnStatusMeninggalKurang.setForeground(new java.awt.Color(50, 50, 50));
        MnStatusMeninggalKurang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnStatusMeninggalKurang.setText("Meninggal < 48 Jam");
        MnStatusMeninggalKurang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnStatusMeninggalKurang.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnStatusMeninggalKurang.setName("MnStatusMeninggalKurang"); // NOI18N
        MnStatusMeninggalKurang.setPreferredSize(new java.awt.Dimension(170, 26));
        MnStatusMeninggalKurang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnStatusMeninggalKurangActionPerformed(evt);
            }
        });
        SetStatus.add(MnStatusMeninggalKurang);

        MnStatusMeninggalLebih.setBackground(new java.awt.Color(255, 255, 254));
        MnStatusMeninggalLebih.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnStatusMeninggalLebih.setForeground(new java.awt.Color(50, 50, 50));
        MnStatusMeninggalLebih.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnStatusMeninggalLebih.setText("Meninggal > 48 Jam");
        MnStatusMeninggalLebih.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnStatusMeninggalLebih.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnStatusMeninggalLebih.setName("MnStatusMeninggalLebih"); // NOI18N
        MnStatusMeninggalLebih.setPreferredSize(new java.awt.Dimension(170, 26));
        MnStatusMeninggalLebih.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnStatusMeninggalLebihActionPerformed(evt);
            }
        });
        SetStatus.add(MnStatusMeninggalLebih);
        ...
        jLabel30.setBounds(-10, 220, 850, 14);
        ...
        Rganti3.setText("3. Pindah Kamar Pasien ( Ada Riwayat Kepindahan Kamar, Contoh : Pasien Naik Kelas )");
        Rganti3.setName("Rganti3"); // NOI18N
        internalFrame3.add(Rganti3);
        Rganti3.setBounds(75, 182, 620, 20);
        ...
        Rganti2.setText("2. Ubah Kamar Pasien ( Keterangan : Salah Kamar Tanpa Keterangan Kepindahan Kamar ) Sama Seperti No.1");
        Rganti2.setName("Rganti2"); // NOI18N
        internalFrame3.add(Rganti2);
        Rganti2.setBounds(75, 162, 620, 20);

        buttonGroup2.add(Rganti1);
        Rganti1.setSelected(true);
        Rganti1.setText("1. Ubah Kamar Pasien ( Keterangan : Salah Kamar Tanpa Keterangan Kepindahan Kamar )");
        Rganti1.setName("Rganti1"); // NOI18N
        internalFrame3.add(Rganti1);
        Rganti1.setBounds(75, 142, 620, 20);

        buttonGroup2.add(Rganti4);
        Rganti4.setText("4. Pindah Kamar Pasien Titip ( Contoh : Pasien Kelas 2, Titip Kelas 3 lalu pindah kelas 2 yang seharusnya ditempati )");
        Rganti4.setName("Rganti4"); // NOI18N
        Rganti4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rganti4ActionPerformed(evt);
            }
        });
        internalFrame3.add(Rganti4);
        Rganti4.setBounds(75, 202, 620, 20);
        ...
        if(TPasien.getText().trim().equals("")){
            ...
            if(norawat.isEditable()==true){
                ...
                if(cmbStatus.getSelectedItem().equals("-")){
                    ...
                    try {
                        if(cmbStatus.getSelectedItem().equals("Meninggal") || cmbStatus.getSelectedItem().equals("Meninggal < 48 Jam") || cmbStatus.getSelectedItem().equals("Meninggal > 48 Jam")){
        ...
        if(tabMode.getRowCount()!=0){
            ...
            if(evt.getClickCount()==2){
                ...
                if(i==0){
                    ...
                    if(akses.getkode().equals("Admin Utama") || akses.getbilling_ranap()){
                        MnBillingActionPerformed(null);
                    }else{
                        JOptionPane.showMessageDialog(null,"Hanya Kasir/Keuangan yang dapat mengakses Billing !!!");                        
                    }                    
                }else if(i==3){
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(!(norawat.getText().trim().equals(""))){
                    if(Sequel.cariRegistrasi(norawat.getText())>0){
                        ...
                        i = JOptionPane.showConfirmDialog(rootPane,"Yakin data mau dihapus...???\nCatatan : Fitur Menghapus Data Hanya Untuk Pasien Yang Tidak Jadi RANAP !!!","Konfirmasi",JOptionPane.YES_NO_OPTION);
                        if (i == JOptionPane.YES_OPTION) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if(rs2.next()){
                                ...
                                param.put("norm",rs2.getString("no_rkm_medis"));             
                                param.put("ruang",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),7).toString().replaceAll("  "," "));
                                param.put("dokter",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),18).toString());
                                param.put("kelas", Sequel.cariIsi("select kamar.kelas from kamar inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar.kd_kamar=? ",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),19).toString()));             
                                param.put("tanggaldaftar",Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",rs2.getString("no_rawat2")));             
                                param.put("jamdaftar",Sequel.cariIsi("select reg_periksa.jam_reg from reg_periksa where reg_periksa.no_rawat=?",rs2.getString("no_rawat2")));             
                                param.put("noreg",Sequel.cariIsi("select reg_periksa.no_reg from reg_periksa where reg_periksa.no_rawat=?",rs2.getString("no_rawat2")));             
                                param.put("pendidikan","-");             
                                param.put("agama",Sequel.cariIsi("select pasien.agama from pasien where pasien.no_rkm_medis=?",rs2.getString("no_rkm_medis")));  
                                param.put("dokter",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),6).toString());  
                                param.put("nopeserta",Sequel.cariIsi("select pasien.no_peserta from pasien where pasien.no_rkm_medis=?",rs2.getString("no_rkm_medis")));  
                                param.put("bangsa","Jawa/Indonesia");             
                                param.put("pekerjaan",Sequel.cariIsi("select pasien.agama from pasien where pasien.no_rkm_medis=?",rs2.getString("no_rkm_medis")));
                                param.put("status","Single");
                                param.put("alamat",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),3).toString());
                                param.put("namakeluarga",Sequel.cariIsi("select pasien.namakeluarga from pasien where pasien.no_rkm_medis=?",rs2.getString("no_rkm_medis")));
                                param.put("telp",Sequel.cariIsi("select pasien.no_tlp from pasien where pasien.no_rkm_medis=?",rs2.getString("no_rkm_medis")));
                                param.put("keluarga",Sequel.cariIsi("select pasien.keluarga from pasien where pasien.no_rkm_medis=?",rs2.getString("no_rkm_medis")));
                                param.put("rujukandari",Sequel.cariIsi("select rujuk_masuk.perujuk from rujuk_masuk where rujuk_masuk.no_rawat=?",rs2.getString("no_rawat2")));
                                param.put("chkri",Sequel.cariIsi("select if(count(kamar_inap.no_rawat)>1,'V','') from reg_periksa inner join pasien inner join kamar_inap "+
                                        "on pasien.no_rkm_medis=reg_periksa.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat where reg_periksa.no_rkm_medis=? ",rs2.getString("no_rkm_medis")));
                                param.put("chkrj",Sequel.cariIsi("select if(count(reg_periksa.no_rawat)>1,'V','') from reg_periksa inner join pasien "+
                                ...
                                param.put("emailrs",akses.getemailrs());   
                                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                                param.put("perusahaan",Sequel.cariIsi("select perusahaan_pasien.nama_perusahaan from perusahaan_pasien where perusahaan_pasien.kode_perusahaan=?",Sequel.cariIsi("select pasien.perusahaan_pasien from pasien where pasien.no_rkm_medis =?",rs2.getString("no_rkm_medis"))));  
                        ...
                        param.put("perusahaan",Sequel.cariIsi("select perusahaan_pasien.nama_perusahaan from perusahaan_pasien where perusahaan_pasien.kode_perusahaan=?",Sequel.cariIsi("select pasien.perusahaan_pasien from pasien where pasien.no_rkm_medis =?",TNoRM.getText()))); 
                        param.put("jkel",Sequel.cariIsi("select if(pasien.jk='L','Laki-Laki','Perempuan') from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));             
                        param.put("lahir",Sequel.cariIsi("select DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));             
                        param.put("norm",TNoRM.getText());   
                        ...
                        param.put("dokter",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),18).toString());
                        param.put("agama",Sequel.cariIsi("select pasien.agama from pasien where pasien.no_rkm_medis=?",TNoRM.getText())); 
                        param.put("penjab",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),6).toString());  
                        param.put("nopeserta",Sequel.cariIsi("select pasien.no_peserta from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));             
                        param.put("bangsa","Jawa/Indonesia");             
                        param.put("pekerjaan",Sequel.cariIsi("select pasien.agama from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                        param.put("status",Sequel.cariIsi("select pasien.stts_nikah from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                        param.put("alamat",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),3).toString());
                        param.put("keluarga",Sequel.cariIsi("select pasien.keluarga from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                        param.put("namakeluarga",Sequel.cariIsi("select pasien.namakeluarga from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                        param.put("telp",Sequel.cariIsi("select pasien.no_tlp from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                        param.put("rujukandari",Sequel.cariIsi("select rujuk_masuk.perujuk from rujuk_masuk where rujuk_masuk.no_rawat=?",norawat.getText()));
                        param.put("chkri",Sequel.cariIsi("select if(count(kamar_inap.no_rawat)>1,'V','') from reg_periksa inner join pasien inner join kamar_inap "+
                                "on pasien.no_rkm_medis=reg_periksa.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat where reg_periksa.no_rkm_medis=? ",TNoRM.getText()));
    ...
    private void MnStatusMeninggalKurangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnStatusMeninggalKurangActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else {
            if(tbKamIn.getSelectedRow()>-1){
                if(norawat.getText().trim().equals("")){
                    ...
                    Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and kd_kamar='"+kdkamar.getText()+"' and tgl_masuk='"+TIn.getText()+"' and jam_masuk='"+JamMasuk.getText()+"'","stts_pulang='Meninggal < 48 Jam'");
                    Sequel.mengedit("kamar","kd_kamar='"+tbKamIn.getValueAt(tbKamIn.getSelectedRow(),19).toString()+"'","status='KOSONG'");  
                    tampil();
                }
            }
        } 
    }//GEN-LAST:event_MnStatusMeninggalKurangActionPerformed

    private void MnStatusMeninggalLebihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnStatusMeninggalLebihActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else {
    ...
    }//GEN-LAST:event_MnStatusMeninggalLebihActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnStatusMeninggalKurang;
    private javax.swing.JMenuItem MnStatusMeninggalLebih;
    ...
    public void isCek(){
        ...
        MnStatusMeninggalKurang.setEnabled(akses.getkamar_inap()); 
        MnStatusMeninggalLebih.setEnabled(akses.getkamar_inap());     
        ...
        MnHapusDataSalah.setEnabled(akses.gethapus_data_salah());
        if(akses.getkode().equals("Admin Utama")){

...
public final class DlgPeriksaLaboratorium extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(560, 290));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(560, 180));
        ...
        jLabel11.setBounds(0, 130, 90, 23);
        ...
        Pemeriksaan.setBounds(250, 130, 520, 23);
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-12-2022" }));
        ...
        BtnCari1.setBounds(770, 130, 30, 23);
        ...
        Scroll1.setBounds(100, 160, 730, 110);
        ...
        btnTarif.setBounds(800, 130, 30, 23);
        ...
        rbAnak.setBounds(170, 130, 80, 23);
        ...
        rbDewasa.setBounds(100, 130, 80, 23);
        ...
        jLabel22.setBounds(0, 100, 92, 23);
        ...
        PanelInput.add(Jk2);
        Jk2.setBounds(100, 100, 160, 23);

        jLabel23.setText("Umur:");
        jLabel23.setName("jLabel23"); // NOI18N
        PanelInput.add(jLabel23);
        jLabel23.setBounds(280, 100, 40, 23);
        ...
        PanelInput.add(Umur);
        Umur.setBounds(330, 100, 160, 23);

        button1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/calculator.png"))); // NOI18N
        ...
        button1.setBounds(850, 180, 60, 50);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
       this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        ...
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            param.put("pekerjaan",Sequel.cariIsi("select (pasien.pekerjaan) as nrp from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
            param.put("nrp",Sequel.cariIsi("select (pasien.nip) as nrp from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
            ...
            param.put("carabayar",Sequel.cariIsi("select penjab.png_jawab from penjab where kd_pj=?",Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rkm_medis=?",TNoRM.getText())));            
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
   try{
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        PeriksaLabJk = Jk2.getText();
        PeriksaLabUmur =  Sequel.cariIsi("select umurdaftar from reg_periksa where no_rawat=?",TNoRw.getText());
        DlgHitungLab HitungLab = new DlgHitungLab(PeriksaLabJk,PeriksaLabUmur);
        HitungLab.setVisible(true);
    ...
    private void isPsien(){
        ...
        try {
            pstindakan=koneksi.prepareStatement(
                "select reg_periksa.no_rkm_medis,reg_periksa.kd_pj,reg_periksa.kd_dokter,dokter.nm_dokter,pasien.nm_pasien,pasien.jk,if(pasien.jk='L','Laki-Laki','Perempuan') as jk2,pasien.umur,"+
            ...
            try {
                ...
                while(rstindakan.next()){
                    ...
                    Jk2.setText(rstindakan.getString("jk2"));
